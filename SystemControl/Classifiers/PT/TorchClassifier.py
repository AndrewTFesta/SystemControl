...
from SystemControl.DataSource.PhysioDataSource import int_to_subject_str
from SystemControl.DataTranforms.SignalImageTranformer import Interpolation
...
def main(main_args):
    ...
    base_dir = os.path.join(DATA_DIR, 'heatmaps', data_source, interpolation, subject_str)
    out_dir = os.path.join(DATA_DIR, 'models', 'torch',  data_source, interpolation, subject_str, f'{model_name}')
