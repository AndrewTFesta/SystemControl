...
from SystemControl.utils.Misc import uv_to_volts
from SystemControl.utils.ObserverObservable import Observable


class LslGanglion(Observable):
...
def main(main_args):
    ...
    lsl_client = LslGanglion()
    data_source = LiveDataSource(subscriber_list=[lsl_client], subject=current_subject, trial_type=trial_type)
